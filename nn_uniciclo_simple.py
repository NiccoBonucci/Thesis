...
weights = torch.tensor([2.0, 1.0, 10.0])  # Pesi per x, y, theta
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), 'simple_unicycle_model.pth')

print('Addestramento completato')

torch.save(model.state_dict(), 'unicycle_model_state_simple.pth')
