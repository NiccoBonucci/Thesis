...
# RETE NEURALE 1 - SEPARAZIONE STRATI PER VALUTAZIONE ANGOLO ACCURATA - 3 HIDDEN LAYER
...
"""class PyTorchModel(nn.Module):
    ...
    def forward(self, x):
        ...
        return output  """
"""
# RETE NEURALE 1 - SEPARAZIONE STRATI PER VALUTAZIONE ANGOLO ACCURATA - 1 HIDDEN LAYER
...
w_x = 1.0  # Peso per x
w_y = 1.0  # Peso per y
w_theta = 3.0  # Peso maggiore per l'orientamento theta
...
#ocp.add_objective(ocp.integral(w_x*(x - final_X[0])**2 + w_y*(y - final_X[1])**2 + w_theta*(theta - final_X[2])**2))
